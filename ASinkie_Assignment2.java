...
public static void main(String[] args) {
    ...
    Patient patient = new Patient("Amanuel", "Geria", "Sinkie", "11011 Abbey Station Ln", "Silver Spring", "Maryland", 20901, 2029297004, "Geria Sinkie", 702577440);
    Date d = new Date();
    Procedure procedure1 = new Procedure("Blood test", d, "Dr. Doofenshmirtz", 250.00); 
    Procedure procedure2 = new Procedure("Physical Exam", d, "Dr. McDreamy", 500.00); 
    Procedure procedure3 = new Procedure("X-ray", d, "Dr. Grey", 300.00);
